function findClosestValueInBst(tree, target) {
  ...
  while (currentNode!==null) {
    ...
    if (target > currentNode.value) {
      currentNode = getNodeBasedOnId(currentNode.right);
      // closestValue = currentNode.right;
...
function getNodeBasedOnId(nodeDirection){

  //it will search for the element that has id equal to 502
  // and return the entire element corresponding to that
...
console.log("closest value", findClosestValueInBst(bst.tree, bst.target));
